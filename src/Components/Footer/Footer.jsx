    ...
    <div className="footer">
      <div className="secContainer container grid">
        ...
        <div data-aos="fade-up" data-aos-duration="5000" className="footerLinks">
          ...
          <span className="phone">1800 889 6333</span>
          <span className="email">travelIndia@gmail.com</span>
        </div>


      </div>
      <hr/>
      <p class="copy-right">Copyright © www.travelIndia.com | website designed by <span>Soumya Ranjan Behera</span> | <br/> All rights reserved! </p>
    </div>
